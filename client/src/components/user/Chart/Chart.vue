...
export default {
    ...
    created: function () {
        ...
        if(machine_name.indexOf("ALL")>-1){                  // 조회회선이 ALL이면(모든회원 조회가능) 회원명을 보이게 하고, 
            ...
            // ALL이 없으면 자기것만 보는 일반회원              // 일반회원이면 안보이게 하기 위함. (col-md-6 과 col-md-4로 디자인이 이쁘지 않아서)
    ...
    methods: {
        ...
        fetchChartList: function () {
            ...
            if(daydiff > 91 ){
                ...
                axios.post(Config.base_url+'/user/chart/chartlist',{
                    "indate": this.indate,
                    "gubun1": this.gubun1,      //표기방식
                    "gubun2": this.gubun2,      //대분류
                    "gubun3": this.gubun3,      //중분류
                    "gubun4": this.gubun4,      //회원조회가능케이블
                    "grpgubun": this.grpgubun   // normalshow에 해당하는 일반회원에 대해서 권한체크
                }).then(function (response) {
        ...
        downloadFile: function () {
            ...
            axios.post(Config.base_url+'/user/chart/downloadfile',{
                "indate": this.indate,
                "gubun1": this.gubun1,
                "gubun2": this.gubun2,
                "gubun3": this.gubun3,
